...
class QuestStorage {
    ...
    private val requestList: SnapshotStateList<Quest> = mutableStateListOf(
        KillQuest(0, 0, 0, "Test_Name", "Test_Description", "Test_Icon", 1, 1, 1, 1, UnitTypes.BARBARIAN, 2),
        KillQuest(0, 1, 0, "Test_Name", "Test_Description", "Test_Icon", 1, 1, 1, 1, UnitTypes.BARBARIAN, 3),
        KillQuest(0, 2, 1,"Test_Name", "Test_Description", "Test_Icon", 1, 1, 1, 1, UnitTypes.BARBARIAN, 5),
    )
