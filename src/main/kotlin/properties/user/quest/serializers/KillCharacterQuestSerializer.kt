...
class KillCharacterQuestSerializer : KSerializer<KillCharacterQuest> {
    override val descriptor: SerialDescriptor = buildClassSerialDescriptor("killCharacterQuest") {
        element<String>("type")
        element<Int>("id")
        element<Int>("x")
        element<Int>("y")
    ...
    override fun deserialize(decoder: Decoder): KillCharacterQuest = decoder.decodeStructure(descriptor) {
        var id: Int? = null
        var x: Int? = null
        var y: Int? = null
        ...
        return@decodeStructure KillCharacterQuest(
            ...
            additional?.toInt() ?: throw SerializationException("Missing additional"),
        )
    }

    @OptIn(ExperimentalSerializationApi::class)
    override fun serialize(encoder: Encoder, value: KillCharacterQuest) = encoder.encodeStructure(descriptor) {
        ...
        encodeStringElement(descriptor, 11, value.charID.toString())
    }
}