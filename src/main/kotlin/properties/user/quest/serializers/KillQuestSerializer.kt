...
class KillQuestSerializer : KSerializer<KillQuest> {
    override val descriptor: SerialDescriptor = buildClassSerialDescriptor("killQuest") {
        element<String>("type")
        element<Int>("id")
        element<Int>("x")
        element<Int>("y")
    ...
    override fun deserialize(decoder: Decoder): KillQuest = decoder.decodeStructure(descriptor) {
        var id: Int? = null
        var x: Int? = null
        var y: Int? = null
        ...
        return@decodeStructure KillQuest(
            ...
            UnitTypes.valueOf(additional ?: throw SerializationException("Missing additional")),
        )
    }

    @OptIn(ExperimentalSerializationApi::class)
    override fun serialize(encoder: Encoder, value: KillQuest) = encoder.encodeStructure(descriptor) {
        ...
        encodeStringElement(descriptor, 11, value.unitType.toString())
    }
}